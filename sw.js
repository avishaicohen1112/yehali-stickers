...
/* חובה להעלות את המספר בכל שינוי בקוד/CSS, אחרת מכשירים שכבר התקינו
   ימשיכו לקבל את הגרסה הישנה מהקאש. v11 = תיקון באג אמיתי: כרטיסי
   חנות/מפות נמתחו לכל גובה המסך על מסך שולחני (align-items:stretch
   בלי תקרה), וצבעי המפות היו כהים מדי כי נלקחו מפלטת הרצפה במקום
   glow. v10 = עיצוב ממשק מחדש: פונטים מקומיים, סולם צבעים, מערכת
   חומרים, מסך בית, חנות עם טאבים. */
const CACHE = 'yehali-stickers-v11';
